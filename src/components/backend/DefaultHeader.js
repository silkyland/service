...
class DefaultHeader extends Component {
  ...
  async componentDidMount() {
    const auth = (await JSON.parse(localStorage.getItem("auth"))) || null;
    if (!auth) {
      this.context.router.history.push("/login");
    } else {
            ...
            <DropdownMenu right style={{ right: "auto" }}>
              ...
              <DropdownItem
                onClick={() => {
                  swal({
                    title: "แน่ใจหรือไม่?",
                    text: "แน่ใจหรือไม่ที่จะออกจากระบบ !",
                    type: "warning",
...
export default withApollo(DefaultHeader);
